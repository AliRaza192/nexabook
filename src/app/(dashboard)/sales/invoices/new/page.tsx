        ...
        <div className="col-span-4 space-y-3">
          ...
          <Card className="border-gray-200 shadow-sm">
            <CardContent className="p-4 space-y-2">
              ...
              <Button variant="outline" className="w-full h-10 border-orange-300 text-orange-700 hover:bg-orange-50 hover:text-orange-800 hover:border-orange-400 font-semibold" onClick={() => router.push("/sales/invoices")}><X className="mr-2 h-4 w-4" />CLOSE</Button>
            </CardContent>
          </Card>
        </div>
      </div>

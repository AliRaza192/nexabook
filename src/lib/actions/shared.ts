...
async function seedDefaultChartOfAccounts(orgId: string): Promise<void> {
  const defaultAccounts = [
    ...
    { code: "1210", name: "Input Tax", type: "asset", subType: "input_tax", description: "Recoverable input tax (GST)" },
    { code: "1211", name: "SRB Input Tax", type: "asset", subType: "input_tax_srb", description: "Recoverable Sindh sales tax on services" },
    { code: "1212", name: "PRA Input Tax", type: "asset", subType: "input_tax_pra", description: "Recoverable Punjab sales tax on services" },
    { code: "1213", name: "KPRA Input Tax", type: "asset", subType: "input_tax_kpra", description: "Recoverable KP sales tax on services" },
    { code: "1214", name: "BRA Input Tax", type: "asset", subType: "input_tax_bra", description: "Recoverable Balochistan sales tax on services" },

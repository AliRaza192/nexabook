...
async function seedDefaultChartOfAccounts(orgId: string): Promise<void> {
  const defaultAccounts = [
    ...
    { code: "1210", name: "Input Tax", type: "asset", subType: "tax_receivable", description: "Recoverable input tax (GST)" },
    { code: "1211", name: "SRB Input Tax", type: "asset", subType: "tax_receivable_srb", description: "Recoverable Sindh sales tax on services" },
    { code: "1212", name: "PRA Input Tax", type: "asset", subType: "tax_receivable_pra", description: "Recoverable Punjab sales tax on services" },
    { code: "1213", name: "KPRA Input Tax", type: "asset", subType: "tax_receivable_kpra", description: "Recoverable KP sales tax on services" },
    { code: "1214", name: "BRA Input Tax", type: "asset", subType: "tax_receivable_bra", description: "Recoverable Balochistan sales tax on services" },
    ...
    { code: "2200", name: "Sales Tax Payable", type: "liability", subType: "tax_payable", description: "Sales tax collected but not remitted (GST)" },
    { code: "2201", name: "SRB Payable", type: "liability", subType: "tax_payable_srb", description: "Sindh sales tax on services payable" },
    { code: "2202", name: "PRA Payable", type: "liability", subType: "tax_payable_pra", description: "Punjab sales tax on services payable" },
    { code: "2203", name: "KPRA Payable", type: "liability", subType: "tax_payable_kpra", description: "KP sales tax on services payable" },
    { code: "2204", name: "BRA Payable", type: "liability", subType: "tax_payable_bra", description: "Balochistan sales tax on services payable" },
    ...
    { code: "4500", name: "Exchange Gain", type: "income", subType: "exchange_gain", description: "Gain from currency exchange rate fluctuations" },
    ...
    { code: "6650", name: "Exchange Loss", type: "expense", subType: "exchange_loss", description: "Loss from currency exchange rate fluctuations" },
